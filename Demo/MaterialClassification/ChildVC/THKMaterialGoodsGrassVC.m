...
@interface THKMaterialGoodsGrassVC ()

@property (nonatomic, strong) THKMaterialGoodsGrassVM *viewModel;

@property (nonatomic, assign) BOOL needExposeVisibleCell;

@end

@implementation THKMaterialGoodsGrassVC
@dynamic viewModel;
...
- (void)bindViewModel {
    [self.viewModel bindWithView:self.view scrollView:self.scrollView appenBlock:^NSArray * _Nonnull(THKResponse * _Nonnull x) {
        THKMaterialRecommendGoodsGrassResponse *response = (THKMaterialRecommendGoodsGrassResponse *)x;
