//
//  TMCardComponentTitleSubTitleUpSideDownStyleCell.m
//  HouseKeeper
//
...
#import "TMCardComponentTitleSubTitleUpSideDownStyleCell.h"
#import "TMCardComponentCellSizeTool.h"
#import "TMCardComponentTool.h"
#import "THKTextTagLabel.h"

@interface TMCardComponentTitleSubTitleUpSideDownStyleCell()

@property (nonatomic, strong) UIView *subTitleBoxView;///< 标签串或副标题信息块视图，包含距离上部10pt间距及最多一行文本的高度和
@property (nonatomic, strong) UILabel *subTitleLbl;///< 副标题文本视图

@property (nonatomic, strong) UIView *titleBoxView;///< 标题信息块视图，包含距离上部8pt间距及最多两行文本的高度和,若无标题则为0
...
@implementation TMCardComponentTitleSubTitleUpSideDownStyleCell
...
- (void)loadSubUIElement {
    ...
    [self.titleBoxView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.mas_equalTo(self.subTitleBoxView.mas_bottom);
        make.leading.trailing.mas_equalTo(0);
        make.height.mas_equalTo(0);
    }];
