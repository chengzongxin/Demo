...
CGFloat CHTFloorCGFloat(CGFloat value) {
...
- (void)prepareLayout {
  ...
  for (NSInteger section = 0; section < numberOfSections; ++section) {
    ...
    [self.sectionItemAttributes safeAddObject:itemAttributes];
    ...
    top = MAX([self.columnHeights[section][columnIndex] floatValue], minimumInteritemSpacing) - minimumInteritemSpacing + sectionInset.bottom;   
  ...
  while (idx < itemCounts) {
    ...
    [self.unionRects safeAddObject:[NSValue valueWithCGRect:unionRect]];
  }
}
