...
#define thk_kInitVector   @"16-Bytes--String"
#define thk_kAESConfigKey @"d6cc281d43e0ec1d"
...
+ (NSData *)thk_AES128DecryptWithText:(NSString *)encryptText{
    NSData *contentData = [[NSData alloc] initWithBase64EncodedString:encryptText options:NSDataBase64DecodingIgnoreUnknownCharacters];
    NSData *keyData = [thk_kAESConfigKey dataUsingEncoding:NSUTF8StringEncoding];
    NSUInteger dataLength = contentData.length;
    
    void const *initVectorBytes = [thk_kInitVector dataUsingEncoding:NSUTF8StringEncoding].bytes;
